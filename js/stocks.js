...
function setupStocksBuyPopup() {
  ...
  // Buy type change
  buyTypeSelect.addEventListener('change', updateStocksPriceCalculation);
  ...
  confirmBtn.addEventListener('click', function() {
    ...
    } else if (buyTypeSelect.value === 'per-share') {
...
function setupStocksSellPopup() {
  ...
  // Sell type change
  sellTypeSelect.addEventListener('change', updateStocksSellPriceCalculation);
...
function showStocksSellPopup() {
  ...
  // Reset and show popup
  document.getElementById('stocks-sell-type').value = 'total';
  document.getElementById('stocks-sell-shares').value = '1';
  document.getElementById('stocks-sell-price').value = '';
  document.getElementById('stocks-sell-price').placeholder = 'Gesamterlös';
  document.getElementById('stocks-sell-total-container').style.display = 'none';
